    ...
    public partial class SeedCities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "CityId", "Country", "Name", "PostOffice" },
                values: new object[,]
                {
                    { 1, "Palestine", "Jerusalem", "12345" },
                    { 2, "Palestine", "Ramallah", "54321" },
                    { 3, "Palestine", "Bethlehem", "67890" },
                    { 4, "Palestine", "Hebron", "98765" },
                    { 5, "Palestine", "Nablus", "45678" },
                    { 6, "Palestine", "Gaza City", "23456" },
                    { 7, "Palestine", "Jenin", "34567" },
                    { 8, "Palestine", "Tulkarm", "87654" },
                    { 9, "Palestine", "Qalqilya", "78901" },
                    { 10, "Palestine", "Beit Lahia", "56789" }
                });
        }
